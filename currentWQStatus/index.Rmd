...
```{r TPMap,echo=F,warning=FALSE,message=FALSE,fig.width=7,fig.height=5,fig.align='center',fig.cap="Total Phosphorus Concentrations across the lake for the last two months."}
...
### Total Nitrogen
```{r TNMap,echo=F,warning=FALSE,message=FALSE,fig.width=7,fig.height=5,fig.align='center',fig.cap="Total Nitrogen Concentrations across the lake for the last two months."}
...
```{r SiteMap,echo=F,warning=FALSE,message=FALSE,fig.width=6.5,fig.height=4,fig.align='center',fig.cap="Monitoring location zone designation"}
