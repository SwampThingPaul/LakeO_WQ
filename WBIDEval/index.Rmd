...
## NOTE: run .../src/WBIDEval.R to update geometric mean data file
## Libraries
...
wq.dat.GM.avg$WY=as.character(wq.dat.GM.avg$WY)
...
i=1
  ...
  xlim.val=c(2001,CurWY);by.x=5;xmaj=seq(xlim.val[1],xlim.val[2],by.x);xmin=seq(xlim.val[1],xlim.val[2],by.x/by.x)
...
tmp[,vars]%>%
  ...
  footnote(j=1,i=1,part="header",
           value=as_paragraph(paste("Includes Stations:",
                                    paste(subset(wq.sites,WBID==WBIDs.val[i])$Station.ID,collapse=", "))),ref_symbols=" ")%>%
